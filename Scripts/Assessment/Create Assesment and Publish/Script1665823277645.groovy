...
WebUI.setText(findTestObject('Object Repository/Assessment Page/Page_Profesi.io/input_Email_vs-inputx vs-input--input norma_38a119'), 
    'Create Assesment with disable fitur Lakukan Penilaian Diri Sendiri and enable fitur Aktifkan Fitur Komentar and Gunakan Skor dan Kategori')
...
WebUI.click(findTestObject('Assessment Page/Page_Profesi.io/Button Publikasi'), FailureHandling.STOP_ON_FAILURE)
